...
const Home = () => {
    return (
        <div>
            ...
            <section className="body-variant-blue">
                <div className="body-content">
                    <ul>
                        <h1> content header test</h1>
                        <p>Lorem ipsum dolor sit amet, 
                ...
                <div className="Media">
                    <img src={require("../Images/multi-windows.jpeg")} alt="multiple windows in a row"></img>
                </div>
            </section>
            <section className="body-variant-white">
                <div className="Media">
                    <img src={require("../Images/Sliding Windows-min.jpg")} alt="kitchen window"></img>
                </div>
                <div className="body-content">
                    <ul>
                        <h1> content header test</h1>
